...
ecs-cli compose --project-name blob-storage-web-api --file docker-compose.blob-storage-web-api.yml --ecs-params ecs-param.backend.gen.yml service up --launch-type EC2 --create-log-groups --cluster LEANDA --private-dns-namespace leanda --vpc=${VPC} --enable-service-discovery --aws-profile=${p} ;
...
ecs-cli compose --project-name core-sagahost --file docker-compose.core-sagahost.yml --ecs-params ecs-param.core.gen.yml service up --launch-type FARGATE --create-log-groups --cluster LEANDA --private-dns-namespace leanda --vpc=${VPC} --enable-service-discovery --aws-profile=${p};
