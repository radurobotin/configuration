...
ecs-cli compose --project-name blob --file docker-compose.blob.yml --ecs-params ecs-param.1.yml service up --launch-type EC2 --create-log-groups  --cluster LEANDA --private-dns-namespace leanda  --vpc vpc-0f7d689f1b8d3615b --enable-service-discovery  --aws-profile arqisoft ;
